  ...
  return (
    <div className="h-screen flex items-center justify-center">
      <form onSubmit={submit} className="bg-white p-6 rounded shadow w-80">
        ...
        <input value={u} onChange={e=>setU(e.target.value)} placeholder="Username" className="border p-2 w-full mb-3"/>
        <input value={p} onChange={e=>setP(e.target.value)} placeholder="Password" type="password" className="border p-2 w-full mb-3"/>
